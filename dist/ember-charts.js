...
define('ember-charts/mixins/axes', ['exports', 'module', 'ember'], function (exports, module, _ember) {
  ...
  module.exports = _Ember['default'].Mixin.create({
    ...
    // # ------------------------------------------------------------------------
    numXTicks: _Ember['default'].computed('graphicWidth', 'tickSpacing', 'minXTicks', function () {
    ...
    numYTicks: _Ember['default'].computed('graphicHeight', 'tickSpacing', 'minYTicks', function () {
